...
static param_t __param_list[] = {
    ...
    PARAM_FLOAT(ROLL_RATE_P, 0.0425, false),
    PARAM_FLOAT(PITCH_RATE_P, 0.0425, false),
    PARAM_FLOAT(YAW_RATE_P, 0.3, false),
    PARAM_FLOAT(ROLL_RATE_I, 0.045, false),
    PARAM_FLOAT(PITCH_RATE_I, 0.045, false),
    PARAM_FLOAT(YAW_RATE_I, 0.95, false),
    PARAM_FLOAT(ROLL_RATE_D, 0.0012, false),
    PARAM_FLOAT(PITCH_RATE_D, 0.0012, false),
    ...
    PARAM_FLOAT(HOVER_THRO, 0.4, false),
};
