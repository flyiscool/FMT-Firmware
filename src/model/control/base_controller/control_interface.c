...
static param_t __param_list[] = {
    ...
    PARAM_FLOAT(ROLL_P, 3.5, false),
    PARAM_FLOAT(PITCH_P, 3.5, false),
    PARAM_FLOAT(ROLL_PITCH_CMD_LIM, PI / 6, false),
    PARAM_FLOAT(ROLL_RATE_P, 0.023, false),
    PARAM_FLOAT(PITCH_RATE_P, 0.023, false),
    PARAM_FLOAT(YAW_RATE_P, 0.023, false),
    PARAM_FLOAT(ROLL_RATE_I, 0.007, false),
    PARAM_FLOAT(PITCH_RATE_I, 0.007, false),
    PARAM_FLOAT(YAW_RATE_I, 0.07, false),
    PARAM_FLOAT(ROLL_RATE_D, 0.0008, false),
    PARAM_FLOAT(PITCH_RATE_D, 0.0008, false),
    PARAM_FLOAT(YAW_RATE_D, 0.0008, false),
