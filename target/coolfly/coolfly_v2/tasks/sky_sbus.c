...
void debug_sbus(void)
{
	...
	DLOG_Critical("%d %d %d %d %d %d %d %d",
		      rc_data.rc_chan_val[0], rc_data.rc_chan_val[1], rc_data.rc_chan_val[2], rc_data.rc_chan_val[3],
		      rc_data.rc_chan_val[4], rc_data.rc_chan_val[5], rc_data.rc_chan_val[6], rc_data.rc_chan_val[7]);

	DLOG_Critical("%d %d %d %d %d %d %d %d",
		      rc_data.rc_chan_val[8], rc_data.rc_chan_val[9], rc_data.rc_chan_val[10], rc_data.rc_chan_val[11],
		      rc_data.rc_chan_val[12],rc_data.rc_chan_val[13],rc_data.rc_chan_val[14], rc_data.rc_chan_val[15]);
}
...
static void cf_sbus_parse(void) // just for test
{
	...
	ch_sbus[ 2] = ((uint32_t)sky_sbus.sbus_buff[ 3] >> 6 | ((uint32_t)sky_sbus.sbus_buff[ 4] << 2)  |
	...
	ch_sbus[ 5] = ((uint32_t)sky_sbus.sbus_buff[ 7] >> 7 | ((uint32_t)sky_sbus.sbus_buff[ 8] << 1)  |
	...
	ch_sbus[10] = ((uint32_t)sky_sbus.sbus_buff[14] >> 6 | ((uint32_t)sky_sbus.sbus_buff[15] << 2)  |
	...
	ch_sbus[13] = ((uint32_t)sky_sbus.sbus_buff[18] >> 7 | ((uint32_t)sky_sbus.sbus_buff[19] << 1)  |
