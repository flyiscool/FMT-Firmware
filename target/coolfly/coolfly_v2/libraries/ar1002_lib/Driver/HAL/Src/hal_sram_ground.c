...
void HAL_SRAM_ReceiveVideoConfig(void)
{
    ...
    NVIC_SetPriority(BB_SRAM_READY_IRQ_0_VECTOR_NUM,NVIC_EncodePriority(NVIC_PRIORITYGROUP_4,INTR_NVIC_PRIORITY_SRAM0,0));
    ...
    NVIC_SetPriority(BB_SRAM_READY_IRQ_1_VECTOR_NUM,NVIC_EncodePriority(NVIC_PRIORITYGROUP_4,INTR_NVIC_PRIORITY_SRAM1,0));
