...
static param_t __param_list[] = {
    ...
    PARAM_FLOAT(VEL_XY_I, 0.1),
    PARAM_FLOAT(VEL_XY_D, 0.1),
    PARAM_FLOAT(VEL_Z_P, 0.55),
    PARAM_FLOAT(VEL_Z_I, 0.04),
    ...
    PARAM_FLOAT(ROLL_RATE_P, 0.04),
    PARAM_FLOAT(PITCH_RATE_P, 0.04),
    PARAM_FLOAT(YAW_RATE_P, 0.1),
    PARAM_FLOAT(ROLL_RATE_I, 0.001),
    PARAM_FLOAT(PITCH_RATE_I, 0.001),
    PARAM_FLOAT(YAW_RATE_I, 0.15),
    PARAM_FLOAT(ROLL_RATE_D, 0.001),
    PARAM_FLOAT(PITCH_RATE_D, 0.001),
