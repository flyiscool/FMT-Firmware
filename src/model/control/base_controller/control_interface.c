...
static param_t __param_list[] = {
    ...
    PARAM_FLOAT(ROLL_RATE_P, 0.0325),
    PARAM_FLOAT(PITCH_RATE_P, 0.0325),
    PARAM_FLOAT(YAW_RATE_P, 0.04),
    PARAM_FLOAT(ROLL_RATE_I, 0.01),
    PARAM_FLOAT(PITCH_RATE_I, 0.01),
    PARAM_FLOAT(YAW_RATE_I, 0.1),
    PARAM_FLOAT(ROLL_RATE_D, 0.0005),
    PARAM_FLOAT(PITCH_RATE_D, 0.0005),
    PARAM_FLOAT(YAW_RATE_D, 0.0002),
